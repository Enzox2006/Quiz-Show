const grafica = {
    ...
    _statusBar(leftText, rightText, onLeftClick) {
        ...
        if (onLeftClick) {
            ...
            leftSpan.addEventListener("mouseenter", () => { leftSpan.style.color = "rgba(255,255,255,0.85)"; });
            leftSpan.addEventListener("mouseleave", () => { leftSpan.style.color = "rgba(255,255,255,0.4)"; });
