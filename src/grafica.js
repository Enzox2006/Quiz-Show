const grafica = {
    ...
    _statusBar(leftText, rightText, onLeftClick) {
        ...
        let leftSpan = makeSpan(leftText);
        if (onLeftClick) {
            leftSpan.style.cursor = "pointer";
            leftSpan.style.transition = "color 0.2s";
            leftSpan.addEventListener("mouseenter", () => {
                leftSpan.style.color = "rgba(255,255,255,0.85)";
            });
    ...
    home() {
        this._statusBar("● ON AIR · STUDIO 1000", "GIOCHI");
        ...
        subtitle.innerHTML =
            "Scegli il gioco. Premi il tasto. Le luci dello studio sono tutte per te.";
        ...
        cardsRow.style.cssText = `
            ...
            display: flex; justify-content: center; gap: 28px; padding: 0 60px;
        `;
        ...
        let card3 = this._gameCard({
            ...
            desc: "La sfida a coppie con le parole-indizio. Una parola, un'intesa: chi ne indovina di più vince.",
            btnText: "ENTRA IN STUDIO →",
            active: true,
            accentColor: "#f0c800",
            onClick: () => {
        ...
        let card4 = this._gameCard({
            label: "GIOCO",
            gameName: "RUOTA",
            gameTitle: "DELLA FORTUNA",
            desc: "3 giocatori, 5 manche, una ruota che decide tutto. Consonanti, vocali e la frase da scoprire lettera per lettera.",
            btnText: "ENTRA IN STUDIO →",
            active: true,
            accentColor: "#f0c800",
            onClick: () => {
        ...
        `;
        dlZone.addEventListener("click", () => {
            window.location.href = "./download.html";
        });
        field.appendChild(dlZone);
    },
    ...
    _gameCard({
        ...
        card.style.cssText = `
            ...
            border-radius: 22px; padding: 40px 34px 36px;
    ...
    setup() {
        ...
        let subtitle = document.createElement("p");
        subtitle.innerHTML =
            "Imposta il concorrente e premi inizia. 21 risposte sbagliate, contro il tempo.";
        subtitle.style.cssText = `
        ...
        nomeInput.value =
            main.nomeGiocatore !== "CONCORRENTE" ? main.nomeGiocatore : "";
        ...
        hint.innerHTML =
            "Scorciatoie: A&nbsp;/&nbsp;1 risposta sinistra &nbsp;·&nbsp; B&nbsp;/&nbsp;2 risposta destra &nbsp;·&nbsp; Spazio pausa";
        hint.style.cssText = `
    ...
    _startFromSetup() {
        let nomeVal = (
            document.getElementById("setupNome").value.trim() || "CONCORRENTE"
        ).toUpperCase();
        let monteVal =
            parseInt(document.getElementById("setupMontepremi").value) ||
            100000;
        let durVal =
            parseInt(document.getElementById("setupDurata").value) || 150;
    ...
    gioco() {
        ...
        topMontepremiEl = this._topInfoCard(
            "MONTEPREMI",
            tool.formatMontepremi(main.montepremi),
        );
        topProgressoEl = this._topInfoCard(
            "PROGRESSO",
            `0 / ${TOTAL_QUESTIONS}`,
        );
    ...
    giusto() {
        ...
        if (topProgressoEl)
            topProgressoEl.valueEl.innerHTML = `${streak} / ${TOTAL_QUESTIONS}`;
    ...
    sbagliato() {
        ...
        if (topProgressoEl)
            topProgressoEl.valueEl.innerHTML = `0 / ${TOTAL_QUESTIONS}`;
